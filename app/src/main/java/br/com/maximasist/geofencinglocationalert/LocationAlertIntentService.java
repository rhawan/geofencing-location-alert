...
public class LocationAlertIntentService extends IntentService {
    ...
    private void notifyLocationAlert(String locTransitionType, String locationDetails) {
        ...
        builder.setDefaults(NotificationCompat.DEFAULT_SOUND | NotificationCompat.PRIORITY_HIGH | NotificationCompat.DEFAULT_VIBRATE | NotificationCompat.DEFAULT_LIGHTS);
