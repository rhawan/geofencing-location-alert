package br.com.maximasist.geofencinglocationalert;
...
public class LocationAlertActivity extends AppCompatActivity
    ...
    public static final int ZOOM_PADRAO = 14;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setMinZoomPreference(ZOOM_PADRAO);
        showCurrentLocationOnMap();
        LatLng coordenadaBase = new LatLng(-16.6971419, -49.2557751);
        centralizarMapa(coordenadaBase);
    ...
    private void centralizarMapa(LatLng coordenadaBase) {
        if (coordenadaBase != null && mMap != null) {
            CameraPosition cameraPosition = new CameraPosition.Builder()
                    .target(coordenadaBase).zoom(ZOOM_PADRAO).build();
